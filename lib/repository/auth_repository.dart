...
class AuthRepository{
  Future loginUser(String _email, String _password, String device) async {
    String baseUrl = "http://localhost/flutterapi/api/auth/login";
  ...
  Future userLogout(String token) async {
    String baseUrl = "http://localhost/flutterapi/api/auth/logout";
  ...
  Future getData(String token) async {
    String baseUrl = "http://localhost/flutterapi/api/auth/me";
